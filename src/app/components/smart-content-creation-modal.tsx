        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          ...
          {step === 3 && (
            <div className="p-6 space-y-3">
              ...
              {/* Grand total */}
              {grandTotal > 0 ? (
                <p className="text-[11px] text-primary/70 flex items-center gap-1.5 pt-1 pb-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary/50 flex-shrink-0" />
                  {grandTotal} item{grandTotal !== 1 ? "s" : ""} queued
                </p>
              ) : (
                <p className="text-[11px] text-muted-foreground/50 flex items-center gap-1.5 pt-1 pb-2">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4 px-5 py-4">
                      ...
                      {/* Item count */}
                      <div className={clsx(
                        "text-xs font-bold tabular-nums flex-shrink-0 min-w-[3.5rem] text-right",
                        itemCount > 0 ? "text-foreground" : "text-muted-foreground/30"
                      )}>
                        {itemCount} {itemCount === 1 ? "item" : "items"}
                      </div>
                    </div>

                    {/* Platform selector — visible when qty > 0 and type supports platforms */}
                    {qty > 0 && hasPlatforms && (
                      <div className="border-t border-border/60 px-5 pb-5 pt-4">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          {platforms.size > 0 && (
                            <span className="text-[10px] font-bold text-primary">{platforms.size} selected</span>
                          )}
                        </div>
